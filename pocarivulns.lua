...
createTab("Main", 1)
createTab("Egg Randomizer", 2)  -- Changed from "Button 2"
...
for i = 3, 5 do
    ...
    label.BackgroundTransparency = 1
    label.Text = "Content for " .. tabName .. " will appear here"
